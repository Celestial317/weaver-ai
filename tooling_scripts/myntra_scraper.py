...
# Set search query inline
search_keyword = 'pink tshirt female'
org_url = search_keyword.strip().replace(" ", "%20")
...
for i in range(1, 2):
    ...
    for d in li_elements:
        ...
        if a_element and 'href' in a_element.attrs:
            href = 'https://www.myntra.com' + (a_element['href'] if a_element['href'].startswith('/') else '/' + a_element['href'])
